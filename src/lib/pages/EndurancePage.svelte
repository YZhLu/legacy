...
<div class="flex flex-col items-center justify-center pt-4">
	<span class="flex pb-4 text-3xl font-bold"><!-- 9° ano --><Icon icon="ph:diamonds-four-duotone" width="38" height="38" /> Resistência</span>
	<span class="pb-4 text-center text-xl font-bold">Vamos aumentar o volume!</span>
	<button
